...
const MenuTENS = ({ onOpenModal }) => {
  ...
  const handleEliminarRegistro = async (registroId) => {
    ...
    try {
      ...
      await procedimientosTENSAPI.eliminar(registroId);
      
      // Recargar registros y métricas
            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all text-gray-900 bg-white hover:border-gray-400 shadow-sm"
                />
              </div>
