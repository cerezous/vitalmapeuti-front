          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-colors text-gray-900 bg-white hover:border-gray-300"
              />
            </div>
