...
const MenuEnfermeria: React.FC<MenuEnfermeriaProps> = ({ onOpenModal }) => {
  ...
  const cargarRegistros = async () => {
    try {
      ...
      const data = await registroProcedimientosAPI.obtenerTodos(params);
  ...
  return (
    ...
    {showMapInfoModal && (
      ...
      <dialog id="fecha-filter-modal-enfermeria" className="modal backdrop:bg-black backdrop:opacity-50">
